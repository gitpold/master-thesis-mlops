...
| **Options considered** | **Option A** | **Option B** | **Option C** | **Option D** |
| --- | --- | --- | --- | --- |
...
| **Decision** | • Component has currently only a low priority and will not get considered in the first MLOps pipeline to set up <br>• the decided on platform Databricks comes with an integrated feature store component which could cover the basic requirements |
|-------|-------|
| **Justification** |  |
| **Decided by** |  |
...
4. [Neptune.ai MLOps Tools Platforms Landscape](https://neptune.ai/blog/mlops-tools-platforms-landscape)
