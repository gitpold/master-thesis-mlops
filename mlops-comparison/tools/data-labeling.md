# 30 Component - Data Labeling

Based on a rapid review of the white and grey literature on MLOps, the following tools were identified for the data labeling category:
...
| **Documentation** | https://docs.labelbox.com/ | https://scale.com/docs | None found | https://doccano.github.io/doccano/ | https://learn.microsoft.com/en-us/azure/machine-learning/how-to-create-image-labeling-projects?view=azureml-api-2 |  |
...
|  |  |  |  |  |  |  |
| **Allowed at Bosch** | ❓<br>• cloud onboarding passed, but entry seems incomplete | ❓<br>• no cloud onboarding info | ❓<br>• no cloud onboarding info | ✅ | ✅ |  |
