...
| **Decision** | • Component has currently only a medium priority and will not get considered in the first MLOps pipeline to set up. |
|-------|-------|
| **Justification** | • there should be no big differences between each option as well as no dependencies to other components → any of these tools could be used based on individual project requirements  |
| **Decided by** |  |
...
2. [ProjectPro Best MLOps Tools](https://www.projectpro.io/article/best-mlops-tools-/574)
3. [Xenonstack MLOps Tools](https://www.xenonstack.com/blog/mlops-tools)
4. [IEEE MLOps Paper](https://ieeexplore.ieee.org/document/9792270)
