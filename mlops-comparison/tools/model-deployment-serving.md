...
| --- | --- | --- | --- | --- | --- | --- | --- |
| **Name & Link** | [Seldon Core](https://www.seldon.io/) | [KServe](https://kserve.github.io/website/) ([Kubeflow](https://www.kubeflow.org/)) | [BentoML](https://www.bentoml.com/) | [LangServe](https://python.langchain.com/docs/langserve/) | [Ray Serve](https://docs.ray.io/en/latest/serve/index.html) | [Azure ML](https://azure.microsoft.com/en-us/products/machine-learning) Endpoints | [Databricks](https://www.databricks.com/) Serving |
...
2. [Xenonstack MLOps Tools](https://www.xenonstack.com/blog/mlops-tools)
3. [Neptune.ai MLOps Tools Platforms Landscape](https://neptune.ai/blog/mlops-tools-platforms-landscape)
4. [Neptune.ai Open Source MLOps Tools](https://neptune.ai/blog/best-open-source-mlops-tools)
5. [DZone MLOps Architectural Models](https://dzone.com/articles/mlops-architectural-models-advanced-guide)
6. [ProjectPro Best MLOps Tools](https://www.projectpro.io/article/best-mlops-tools-/574)
7. [DataCamp MLOps Tools](https://www.datacamp.com/blog/top-mlops-tools)
8. [IEEE MLOps Paper](https://ieeexplore.ieee.org/document/9792270)
