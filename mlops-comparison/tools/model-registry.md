...
| **Decision** | **Option D: Databricks Model Registry** |
|-------|-------|
| **Justification** | • Either Azure ML or Databricks will be used as a base MLOps platform and provide both an integrated model registry so using them is the obvious choice <br> • following the decision in favor of Databricks as platform, the decision is here also made for the corresponding Databricks component |
| **Decided by** |  |
